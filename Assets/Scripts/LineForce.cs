...
public class LineForce : MonoBehaviour
{
    ...
    public bool player1chance = true;
    private LineForce1 lf1;
    ...
    private void Start()
    {
        ...
        lf1 = FindObjectOfType<LineForce1>();
        EulerAngleVelocity = new Vector3(0, 0, 0);
        P=GameObject.FindGameObjectWithTag("corner1");
    }
    ...
    private void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0) && !isAiming && player1chance)
        {
            StartAiming();
        }
    ...
    private void PointChange()
    {
        if (point1)
        {
            P=GameObject.FindGameObjectWithTag("corner");
        }
        else if (point2)
        {
            P = GameObject.FindGameObjectWithTag("corner1");
    ...
    private void Shoot()
    {
        ...
        float strength = Vector3.Distance(transform.position, aimTarget);
